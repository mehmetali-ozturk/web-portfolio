        ...
        <>
            ...
            <div className="lg:hidden w-full bg-white div-shadow rounded-2xl border-gray-300 p-4 mb-5">
                <div className="flex items-center justify-between">
                    <div className='flex items-center space-x-4'>
                        ...
                        <div>
                            <h1 className="text-xl font-bold">{t('personalInfo.name')}</h1>
                            <p className="text-sm bg-gray-100 rounded-lg px-3 py-1 mt-1 max-w-max">{t('personalInfo.title')}</p>
                        </div>
                    </div>
                    <button 
                        onClick={() => setIsOpen(!isOpen)}
                        className="ml-0 p-2 hover:bg-gray-100 rounded-lg transition-colors" 
                    >
            ...
            <div className="hidden lg:flex h-auto max-w-min flex-col bg-white text-black div-shadow rounded-2xl border-gray-300 p-8 font-poppins mr-7">
                <div className="flex flex-col items-center">
                    ...
                    <p className="text-sm rounded-lg p-1 px-4 bg-gray-100 mb-0">{t('personalInfo.title')}</p>
